...
export function ConnectionBar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border shadow-sm" style={{ backgroundColor: 'color-mix(in oklch, var(--color-card) 75%, transparent)', backdropFilter: 'blur(24px) saturate(1.2)', WebkitBackdropFilter: 'blur(24px) saturate(1.2)' }}>
